...
${errorInfo.componentStack}`);
  ...
  function useTranslate() {
    ...
    const translate = (0, import_react19.useCallback)((...args) => {
      const translation = i18n.translate(...args);
      if (!Array.isArray(translation)) {
        return translation;
      }
      return translation.map((part, index) => {
        if (/* @__PURE__ */ (0, import_react19.isValidElement)(part)) {
          return /* @__PURE__ */ (0, import_react19.cloneElement)(part, {
            key: index
          });
        }
        return part;
  ...
  // extensions/tomasz-upsells-ui-extension-training/src/Checkout.tsx
  ...
  function Extension() {
    ...
    const { query } = useApi();
    const [variantData, setVariantData] = (0, import_react20.useState)(null);
    const [isSelected, setIsSelected] = (0, import_react20.useState)(false);
    const cartLines = useCartLines();
    const applyCartLinesChange = useApplyCartLinesChange();
    const settings = useSettings();
    let variantID;
    variantID = settings.selected_variant;
    const variantIDDefault = "gid://shopify/ProductVariant/45204979188014";
    if (!variantID) {
      variantID = variantIDDefault;
    }
    const title = settings.upsell_title;
    ...
    (0, import_react20.useEffect)(() => {
      ...
      if (isSelected) {
        ...
        const cartLineId = (_a = cartLines.find((cartLine) => cartLine.merchandise.id === variantID)) == null ? void 0 : _a.id;
        if (cartLineId) {
          applyCartLinesChange({
            type: "removeCartLine",
            id: cartLineId,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 2, children: title ? title : "" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "base" }),
        ...
        InlineLayout2,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "none", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: variantData.product.title }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
                ...
                " ",
                variantData.priceV2.currencyCode
              ] })
            ] })
          ]
        }
...
//# sourceMappingURL=tomasz-upsells-ui-ext.js.map
